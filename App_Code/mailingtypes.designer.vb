...
Partial Public Class mailingtypesDataContext
  ...
  End Sub
  Partial Private Sub Insertmailingtype(instance As mailingtype)
    End Sub
  Partial Private Sub Updatemailingtype(instance As mailingtype)
    End Sub
  Partial Private Sub Deletemailingtype(instance As mailingtype)
    End Sub
  ...
  Partial Private Sub Deleteclient(instance As client)
    End Sub
  Partial Private Sub Insertclients_dev(instance As clients_dev)
    End Sub
  Partial Private Sub Updateclients_dev(instance As clients_dev)
    End Sub
  Partial Private Sub Deleteclients_dev(instance As clients_dev)
    End Sub
  #End Region
	...
	Public ReadOnly Property mailingtypes() As System.Data.Linq.Table(Of mailingtype)
		Get
			Return Me.GetTable(Of mailingtype)
		End Get
	End Property
	...
	Public ReadOnly Property project_types() As System.Data.Linq.Table(Of project_type)
		Get
			Return Me.GetTable(Of project_type)
		End Get
	End Property
	
	Public ReadOnly Property clients_devs() As System.Data.Linq.Table(Of clients_dev)
		Get
			Return Me.GetTable(Of clients_dev)
		End Get
	End Property
End Class

<Table(Name:="dbo.mailingtype")>  _
Partial Public Class mailingtype
	...
	<Column(Storage:="_granid", DbType:="Int NOT NULL")>  _
	...
	<Association(Name:="mailingtype_mailingtype_desc_mailing", Storage:="_mailingtype_desc_mailings", ThisKey:="mailing_id", OtherKey:="mailing_id")>  _
	...
	<Association(Name:="mailingtype_gran_mailingtype", Storage:="_mailingtype_gran", ThisKey:="granid", OtherKey:="granid", IsForeignKey:=true, DeleteOnNull:=true, DeleteRule:="CASCADE")>  _
		...
		Set
			...
			If ((Object.Equals(previousValue, value) = false)  _
				...
				If ((previousValue Is Nothing)  _
					...
					previousValue.mailingtypes.Remove(Me)
				End If
				Me._mailingtype_gran.Entity = value
				If ((value Is Nothing)  _
							= false) Then
					value.mailingtypes.Add(Me)
...
Partial Public Class mailingtype_parse
	...
	<Association(Name:="mailingtype_gran_mailingtype_parse", Storage:="_mailingtype_gran", ThisKey:="granid", OtherKey:="granid", IsForeignKey:=true, DeleteRule:="CASCADE")>  _
	Public Property mailingtype_gran() As mailingtype_gran
		Get
			Return Me._mailingtype_gran.Entity
		End Get
...
Partial Public Class mailingtype_desc_mailing
	...
	Private _mailingtype As EntityRef(Of mailingtype)
	...
	Public Sub New()
		MyBase.New
		Me._mailingtype = CType(Nothing, EntityRef(Of mailingtype))
	...
	Public Property mailing_id() As Long
		...
		Set
			If ((Me._mailing_id = value)  _
						= false) Then
				If Me._mailingtype.HasLoadedOrAssignedValue Then
					Throw New System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException
				End If
				Me.Onmailing_idChanging(value)
				Me.SendPropertyChanging
	...
	<Association(Name:="mailingtype_mailingtype_desc_mailing", Storage:="_mailingtype", ThisKey:="mailing_id", OtherKey:="mailing_id", IsForeignKey:=true, DeleteOnNull:=true, DeleteRule:="CASCADE")>  _
	Public Property mailingtype() As mailingtype
		Get
			Return Me._mailingtype.Entity
		End Get
		Set
			Dim previousValue As mailingtype = Me._mailingtype.Entity
			If ((Object.Equals(previousValue, value) = false)  _
						OrElse (Me._mailingtype.HasLoadedOrAssignedValue = false)) Then
				Me.SendPropertyChanging
				If ((previousValue Is Nothing)  _
							= false) Then
					Me._mailingtype.Entity = Nothing
					previousValue.mailingtype_desc_mailings.Remove(Me)
				End If
				Me._mailingtype.Entity = value
				If ((value Is Nothing)  _
							= false) Then
					value.mailingtype_desc_mailings.Add(Me)
					Me._mailing_id = value.mailing_id
				Else
					Me._mailing_id = CType(Nothing, Long)
				End If
				Me.SendPropertyChanged("mailingtype")
			End If
		End Set
	End Property
...
Partial Public Class mailingtype_gran
	...
	Private _mailingtypes As EntitySet(Of mailingtype)
	...
	Public Sub New()
		MyBase.New
		Me._mailingtypes = New EntitySet(Of mailingtype)(AddressOf Me.attach_mailingtypes, AddressOf Me.detach_mailingtypes)
	...
	<Association(Name:="mailingtype_gran_mailingtype", Storage:="_mailingtypes", ThisKey:="granid", OtherKey:="granid")>  _
	Public Property mailingtypes() As EntitySet(Of mailingtype)
		Get
			Return Me._mailingtypes
		End Get
		Set
			Me._mailingtypes.Assign(value)
		End Set
	End Property
	
	<Association(Name:="mailingtype_gran_mailingtype_parse", Storage:="_mailingtype_parses", ThisKey:="granid", OtherKey:="granid")>  _
	...
	<Association(Name:="mailingtype_gran_mailingtype_group_gran", Storage:="_mailingtype_group_grans", ThisKey:="granid", OtherKey:="granid")>  _
	...
	<Association(Name:="mailingtype_gran_mailingtype_override", Storage:="_mailingtype_overrides", ThisKey:="granid", OtherKey:="granid")>  _
	...
	Private Sub attach_mailingtypes(ByVal entity As mailingtype)
		Me.SendPropertyChanging
		entity.mailingtype_gran = Me
	End Sub
	
	Private Sub detach_mailingtypes(ByVal entity As mailingtype)
		Me.SendPropertyChanging
...
Partial Public Class mailingtype_group_gran
	...
	<Association(Name:="mailingtype_gran_mailingtype_group_gran", Storage:="_mailingtype_gran", ThisKey:="granid", OtherKey:="granid", IsForeignKey:=true, DeleteOnNull:=true, DeleteRule:="CASCADE")>  _
	Public Property mailingtype_gran() As mailingtype_gran
		Get
			Return Me._mailingtype_gran.Entity
		End Get
...
Partial Public Class mailingtype_override
	...
	<Association(Name:="mailingtype_gran_mailingtype_override", Storage:="_mailingtype_gran", ThisKey:="granid", OtherKey:="granid", IsForeignKey:=true, DeleteRule:="CASCADE")>  _
	Public Property mailingtype_gran() As mailingtype_gran
		Get
			Return Me._mailingtype_gran.Entity
		End Get
...
Partial Public Class client
	...
	Private _clients_dev As EntityRef(Of clients_dev)
	...
	Public Sub New()
		MyBase.New
		Me._clients_dev = CType(Nothing, EntityRef(Of clients_dev))
		OnCreated
	End Sub
	...
	<Association(Name:="client_clients_dev", Storage:="_clients_dev", ThisKey:="cid_email", OtherKey:="cid_email", IsUnique:=true, IsForeignKey:=false)>  _
	Public Property clients_dev() As clients_dev
		Get
			Return Me._clients_dev.Entity
		End Get
		Set
			Dim previousValue As clients_dev = Me._clients_dev.Entity
			If ((Object.Equals(previousValue, value) = false)  _
						OrElse (Me._clients_dev.HasLoadedOrAssignedValue = false)) Then
				Me.SendPropertyChanging
				If ((previousValue Is Nothing)  _
							= false) Then
					Me._clients_dev.Entity = Nothing
					previousValue.client = Nothing
				End If
				Me._clients_dev.Entity = value
				If (Object.Equals(value, Nothing) = false) Then
					value.client = Me
				End If
				Me.SendPropertyChanged("clients_dev")
			End If
		End Set
	End Property
...
<Table(Name:="dbo.project_types")>  _
Partial Public Class project_type
	
	Private _projtypeid As Integer
	
	Private _projtype_desc As String
	
	Private _projtype_code As String
	
	Private _projtype_dir As String
	
	Public Sub New()
		MyBase.New
	End Sub
	
	<Column(Storage:="_projtypeid", DbType:="Int NOT NULL")>  _
	Public Property projtypeid() As Integer
		Get
			Return Me._projtypeid
		End Get
		Set
			If ((Me._projtypeid = value)  _
						= false) Then
	...
	<Column(Storage:="_projtype_desc", DbType:="VarChar(50) NOT NULL", CanBeNull:=false)>  _
	Public Property projtype_desc() As String
		Get
			Return Me._projtype_desc
		End Get
		Set
			If (String.Equals(Me._projtype_desc, value) = false) Then
				Me._projtype_desc = value
			End If
		End Set
	End Property
	
	<Column(Storage:="_projtype_code", DbType:="VarChar(10)")>  _
	Public Property projtype_code() As String
		Get
			Return Me._projtype_code
		End Get
		Set
			If (String.Equals(Me._projtype_code, value) = false) Then
				Me._projtype_code = value
			End If
		End Set
	End Property
	
	<Column(Storage:="_projtype_dir", DbType:="VarChar(50)")>  _
	Public Property projtype_dir() As String
		Get
			Return Me._projtype_dir
		End Get
		Set
			If (String.Equals(Me._projtype_dir, value) = false) Then
				Me._projtype_dir = value
			End If
		End Set
	End Property
End Class

<Table(Name:="dbo.clients_dev")>  _
Partial Public Class clients_dev
	Implements System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	...
	Private _dev_directory_pathname As String
	
	Private _client As EntityRef(Of client)
    ...
    Partial Private Sub Oncid_emailChanged()
    End Sub
    Partial Private Sub Ondev_directory_pathnameChanging(value As String)
    End Sub
    Partial Private Sub Ondev_directory_pathnameChanged()
    End Sub
    #End Region
	
	Public Sub New()
		MyBase.New
		Me._client = CType(Nothing, EntityRef(Of client))
		OnCreated
	End Sub
	
	<Column(Storage:="_cid_email", DbType:="Int NOT NULL", IsPrimaryKey:=true)>  _
	Public Property cid_email() As Integer
		Get
			Return Me._cid_email
		End Get
		Set
			If ((Me._cid_email = value)  _
						= false) Then
				If Me._client.HasLoadedOrAssignedValue Then
					Throw New System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException
				End If
				Me.Oncid_emailChanging(value)
				Me.SendPropertyChanging
	...
	<Column(Storage:="_dev_directory_pathname", DbType:="VarChar(250) NOT NULL", CanBeNull:=false)>  _
	Public Property dev_directory_pathname() As String
		Get
			Return Me._dev_directory_pathname
		End Get
		Set
			If (String.Equals(Me._dev_directory_pathname, value) = false) Then
				Me.Ondev_directory_pathnameChanging(value)
				Me.SendPropertyChanging
				Me._dev_directory_pathname = value
				Me.SendPropertyChanged("dev_directory_pathname")
				Me.Ondev_directory_pathnameChanged
			End If
		End Set
	End Property
	
	<Association(Name:="client_clients_dev", Storage:="_client", ThisKey:="cid_email", OtherKey:="cid_email", IsForeignKey:=true, DeleteOnNull:=true, DeleteRule:="CASCADE")>  _
	Public Property client() As client
		Get
			Return Me._client.Entity
		End Get
		Set
			Dim previousValue As client = Me._client.Entity
			If ((Object.Equals(previousValue, value) = false)  _
						OrElse (Me._client.HasLoadedOrAssignedValue = false)) Then
				Me.SendPropertyChanging
				If ((previousValue Is Nothing)  _
							= false) Then
					Me._client.Entity = Nothing
					previousValue.clients_dev = Nothing
				End If
				Me._client.Entity = value
				If ((value Is Nothing)  _
							= false) Then
					value.clients_dev = Me
					Me._cid_email = value.cid_email
				Else
					Me._cid_email = CType(Nothing, Integer)
				End If
